...
router.post("/", async (req, res) => {
  ...
  const connection = await mysql.createConnection({
    ...
    if (Avatar_Image !== undefined) {
      ...
      const updateImageQuery = 'UPDATE Avatar SET Avatar_Image = ? WHERE id = ?';
    ...
    if (Avatar !== undefined) {
      ...
      const updateAvatarQuery = 'UPDATE Avatar SET Avatar = ? WHERE id = ?';
...
app.use(`/.netlify/functions/updateAvatar`, router);
