      ...
      return new Promise(() => {
          ...
          if (target?.files.length) {
              ...
              reader.onload = e2 => {
                  ...
                  const fullFileName = target.files[0].name;
                  // Extract the name without extension
                  const fileNameWithoutExtension = fullFileName.split('.').slice(0, -1).join('.');
                  // Display and log the file name without extension
                  this.fileDisplay(fileNameWithoutExtension);
                  console.log("Uploaded file name without extension:", fileNameWithoutExtension);
              };
