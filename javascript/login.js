...
document.getElementById('login-button').addEventListener('click', async (event) => {
    ...
    try {
      ...
      const signupSuccesMessage = document.getElementById('signup-succes-message'); // The element to display the error message
      ...
      try {
          ...
          if (resp.status === 204) {
            ...
            signupSuccesMessage.textContent = 'Signup successful. Check your email for further instructions.';
        ...
        signupErrorMessage.textContent = 'An error occurred during signup. Please try again later.'; // Set a generic error message
        signupErrorMessage.style.display = 'block'; // Show the error message element
    }
});
      ...
      document.getElementById('confirm-forgot-password').addEventListener('click', async () => {
